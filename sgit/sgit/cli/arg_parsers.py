...
def build_arg_parser():
    ...
    argsp.add_argument("type", choices=["blob", "commit", "tag", "tree"], help="Specify the type")
    ...
    argsp.add_argument("-t", dest="type", choices=["blob", "commit", "tag", "tree"], default="blob", help="Specify the type")
    ...
    argsp.add_argument("-r", dest="recursive", action="store_true", help="Recursively list the objects in each tree.")
    ...
    argsp.add_argument("--sgit-type", dest="type", choices=["blob", "commit", "tag", "tree"], default=None, help="Specify the expected type")
